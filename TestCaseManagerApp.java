...
/***************************************************************************************
 * @title   The TestCaseManagerApp class.
 *
 * @author  Frances Felicidario
 * @version V1.1
 ***************************************************************************************/
public class TestCaseManagerApp extends Application
{
    // Instance data
    ...
    /***********************************************************************************
     * JavaFX start method. Sets up the main window and user interface.
     *
    ...
    public void start(Stage primaryStage)
    {
        ...
        primaryStage.setTitle("Test Case Manager");
